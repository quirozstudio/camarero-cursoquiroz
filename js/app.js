import { renderShell } from "./components/shell.js?v=0.2.2";
import { routes } from "./routes.js?v=0.2.2";
import { getCurrentCourse, getRegionById } from "./services/course-service.js?v=0.2.2";
